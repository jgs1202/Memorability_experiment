...
for j in range(2):
    for k in range(7):
        os.chdir('/Users/Aoyama/Documents/B4/Memorability_data/tulip/csv/1000nodes/originData')
        f = open(str(j) + '.csv', 'r')
        ...
        os.chdir('/Users/Aoyama/Documents/B4/Memorability_data/tulip/csv/1000nodes/dummyData/'+str(j))
