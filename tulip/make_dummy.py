...
for j in range(2):
    for k in range(7):
        os.chdir('/Users/Aoyama/Documents/B4/Memorability_data/tulip/csv/100nodes/manyData')
        f = open(str(j) + '.csv', 'r')
        ...
        os.chdir('/Users/Aoyama/Documents/B4/Memorability_data/tulip/csv/100nodes/dummyData/'+str(j))
