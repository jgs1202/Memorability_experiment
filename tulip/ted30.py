...
for j in range(1,5):
    ...
    os.chdir('/Users/Aoyama/Documents/B4/noOauth_test/tulip/csv/30nodes/originData')
    f = open(str(j) + '.csv', 'r')
    ...
    for k in range(4):
        ...
        os.chdir('/Users/Aoyama/Documents/B4/noOauth_test/tulip/csv/30nodes/ted/' + str(rank) + '0%/'+str(j))
        f = open( '' + str(k) + '.csv', 'w')
        writer = csv.writer(f)
        for i in data1:
            writer.writerow(i)
